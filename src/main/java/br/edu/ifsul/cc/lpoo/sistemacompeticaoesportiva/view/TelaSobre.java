...
public class TelaSobre extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sistema de Controle de Funcionários e Projetos");

        jLabel2.setText("<html> <p> Sistema de Controle de Funcionários e Projetos implementado na disciplina de LPOO como aprendizado de Programação Visual usando persistência em Banco de Dados e linguagem de programação Java. </p> </html>");

        jLabel3.setText("Francisco Junior");
