...
public class TelaDepartamento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Departamentos Cadastrados");
    ...
    private void btnNovaPessoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovaPessoaActionPerformed
        TelaCadastroDepartamento telaCadastro
                = new TelaCadastroDepartamento(this, rootPaneCheckingEnabled);
    ...
    private void btnRemoverPessoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverPessoaActionPerformed
        Departamento departamentoSel = lstFuncionarios.getSelectedValue();
        if (departamentoSel != null) {
            System.out.println("Funcionário: " + departamentoSel.getId());
            try {
                jpa.conexaoAberta();

                int delOp = JOptionPane.showConfirmDialog(this,
                        "Tem certeza que deseja remover " + departamentoSel.getNome() + "?");
                if (delOp == JOptionPane.YES_OPTION) {
                    jpa.remover(departamentoSel);
                }
                ...
                JOptionPane.showMessageDialog(this,
                        "Erro ao remover Departamento " + departamentoSel + "\n" + e);
            }
        } else {
    ...
    private void txtBuscaNomeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscaNomeKeyReleased
        if(txtBuscaNome.getText().trim().isEmpty()){
            ...
            modeloLista.addAll(jpa.getDepartamentos(txtBuscaNome.getText().trim()));
            System.out.println("Funcionários carregados: "+jpa.getDepartamentos(txtBuscaNome.getText().trim()));
    ...
    private void btnEditarPessoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarPessoaActionPerformed
        Departamento departamentoSel = lstFuncionarios.getSelectedValue();
        if (departamentoSel != null) {
            TelaCadastroDepartamento telaEdt = new TelaCadastroDepartamento(this, rootPaneCheckingEnabled);
            telaEdt.setDepartamento(departamentoSel);
    ...
    private void carregarDepartamentosCadastrados(){
        jpa.conexaoAberta();

        DefaultListModel modeloLista = new DefaultListModel();
        modeloLista.addAll(jpa.getDepartamentos());
        lstFuncionarios.setModel(modeloLista);
    ...
    private javax.swing.JList<Departamento> lstFuncionarios;
