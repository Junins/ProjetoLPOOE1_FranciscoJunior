...
public class TelaFuncionario extends javax.swing.JFrame {
    ...
    private void btnRemoverPessoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverPessoaActionPerformed
        ...
        if (funcionarioSel != null) {
            System.out.println("Funcionário: " + funcionarioSel.getId());
            try {
                jpa.conexaoAberta();
                ...
                JOptionPane.showMessageDialog(this,
                        "Erro ao remover funcionario " + funcionarioSel + "\n" + e);
            }
        } else {
    ...
    private void txtBuscaNomeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscaNomeKeyReleased
        if(txtBuscaNome.getText().trim().isEmpty()){
            ...
            modeloLista.addAll(jpa.getFuncionarios(txtBuscaNome.getText().trim()));
            System.out.println("Funcionários carregados: "+jpa.getFuncionarios(txtBuscaNome.getText().trim()));
